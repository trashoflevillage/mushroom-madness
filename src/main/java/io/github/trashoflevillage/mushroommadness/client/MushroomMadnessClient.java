...
//		EntityRendererRegistry.register(ModEntities.MUSHROOM_ZOMBIE, MushroomZombieEntity::new);
//		EntityModelLayerRegistry.registerModelLayer(ModModelLayers.MUSHROOM_ZOMBIE, ZombieEntityModel::);
	}
}