...
//    public static final MapCodec<SporeDecorator> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
//        return instance.group(Codec.floatRange(0.0F, 1.0F).fieldOf("probability").forGetter((p) -> {
//            return p.probability;
//        }), Codec.intRange(0, 16).fieldOf("treeHeight").forGetter((p) -> {
//            return p.treeHeight;
